...
This is an example of semantic image segmentation using the pre-trained dilated convolution model. the original post can be found here https://github.com/ndrplz/dilation-tensorflow
